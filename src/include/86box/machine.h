...
extern int machine_at_tiger100_init(const machine_t *);
...
extern int machine_at_mx64_init(const machine_t *);
...
extern int machine_at_6bx7p_init(const machine_t *);
...
extern int machine_at_av11_init(const machine_t *);
