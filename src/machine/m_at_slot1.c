...
int
machine_at_tiger100_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/tiger100/Tiger 100 (S1832DL)_2.00.05.rom",
                           0x000c0000, 262144, 0);
...
int
machine_at_mx64_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/mx64/MX64104.bin",
                           0x000c0000, 262144, 0);
