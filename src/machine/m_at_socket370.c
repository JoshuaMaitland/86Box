...
int
machine_at_av11_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/av11/AV11S83B.BIN",
                           0x000c0000, 262144, 0);
...
int
machine_at_6bx7p_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/6bx7p/6bx7p.F5",
			   0x000c0000, 262144, 0);
